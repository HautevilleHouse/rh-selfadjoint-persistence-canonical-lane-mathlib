# RH Selfadjoint Persistence — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/rh-selfadjoint-persistence-canonical-lane-mathlib.git
cd rh-selfadjoint-persistence-canonical-lane-mathlib
lake exe
lake build
```
